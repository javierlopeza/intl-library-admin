...
// Create a Author
router.post('/Authors', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Author
router.put('/Authors/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Author
router.delete('/Authors/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/Authors', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/Authors/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Author
router.get('/Authors/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/Authors.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
